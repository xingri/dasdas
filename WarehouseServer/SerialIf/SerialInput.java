...
public class SerialInput implements SerialPortEventListener {
	...
	*/
	...
	public void initialize() {
		...
		System.out.println("Check initialize");
	...
	public synchronized void serialEvent(SerialPortEvent oEvent) {
		System.out.println("event hanlder called");
		System.out.println("event type: " + oEvent.getEventType());
		System.out.println("expected event type: " + SerialPortEvent.DATA_AVAILABLE);
		if (oEvent.getEventType() == SerialPortEvent.DATA_AVAILABLE) {
			System.out.println("Check data available");	

			try {
   				byte[] readBuffer = new byte[20];
   				int numBytes = 0;
				System.out.println("Check readBuffer");	
				...
				//System.out.println("accepted info : " + inputLine);
			} catch (Exception e) {
				System.err.println(e.toString());
			}
		}
