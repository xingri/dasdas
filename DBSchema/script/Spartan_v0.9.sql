...
-- Dumping data for table spartan.customer: ~5 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` (`phone`, `fname`, `lname`, `address`, `email`) VALUES
	('912312879812', 'vijay', 'rachabattuni', 'Bangalore India 55439945', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=10015 DEFAULT CHARSET=latin1 COMMENT='Status: \r\n0 - Pending\r\n1 - In progress\r\n2 - Backordered\r\n3- Complete';
...
INSERT INTO `orderinfo` (`orderNo`, `orderTime`, `shippingTime`, `status`, `phone`) VALUES
	(1, '2014-06-16 01:28:37', NULL, 2, '912312879812');
...
CREATE TABLE IF NOT EXISTS `robotmoves` (
  ...
  `stationsVisited` tinyint(2) DEFAULT '0' COMMENT '0 - Not visited; 1 - Visited',
  KEY `FK_robotmoves_robot` (`robotId`),
  KEY `FK_robotmoves_orderinfo` (`orderNo`),
  KEY `FK_robotmoves_station` (`stationsToVisit`),
  CONSTRAINT `FK_robotmoves_station` FOREIGN KEY (`stationsToVisit`) REFERENCES `station` (`stationId`),
...
-- Dumping data for table spartan.robotmoves: ~2 rows (approximately)
/*!40000 ALTER TABLE `robotmoves` DISABLE KEYS */;
INSERT INTO `robotmoves` (`robotId`, `orderNo`, `stationsToVisit`, `stationsVisited`) VALUES
	(1, 1, 1, 0),
	(1, 1, 3, 0),
	(1, 1, 2, 0);
...
INSERT INTO `warehouse` (`warehouseId`, `name`, `desc`, `invStations`, `shippingStations`, `robots`, `ipaddress`, `status`) VALUES
	(1, '0', '0', 3, 1, 1, '10.221.121.2', 1);
